...
for (var evt in { keyup: 1, change: 1 }) {
    binary.addEventListener(evt, binChange, false);
    octal.addEventListener(evt, octChange, false);
    decimal.addEventListener(evt, decChange, false);
    hexadecimal.addEventListener(evt, hexChange, false);
}
